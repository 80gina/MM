...
사용자는 홈·데스크톱 안내 문구를 직접 바꿀 수 있습니다. 감정 정리 화면에서는 최신 일기의 사건·마음 초안을 만들고 수정할 수 있으며, ‘지금 무엇이 필요할까요?’ 아래의 예시 5개를 선택해 입력할 수 있습니다. 마음 기록에서는 주간·월간·연간을 고른 뒤 주요 사건 팝업에서 해당 기간의 일기를 사건·감정별 목록으로 확인합니다. 각 항목을 수정하거나 삭제하고, 목록을 브라우저에 저장·삭제할 수 있습니다. 저장한 목록은 보고서 텍스트 파일에도 포함됩니다.

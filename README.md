...
사용자는 홈·데스크톱 안내 문구를 직접 바꿀 수 있습니다. 감정 정리 화면에서는 최신 일기의 사건·마음 초안을 만들고 수정할 수 있습니다. 마음 기록의 보고서에서는 선택 기간의 주요 사건 초안을 생성해 고친 뒤 텍스트 파일에 포함할 수 있습니다.
...
| 기록 그래프·보고서 | 브라우저 localStorage | 최근 400건 | 사건 초안 생성은 별도 동의 | 수치·그래프는 기기 안에서 계산. 사건 초안에는 선택 기간의 일기 최대 10건을 사용 |
